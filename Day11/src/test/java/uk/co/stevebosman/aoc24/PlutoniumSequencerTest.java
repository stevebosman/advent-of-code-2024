...
//  }
  ...
  @Test
  void runPart1() {
    final PlutoniumSequencer sequencer = new PlutoniumSequencer("572556 22 0 528 4679021 1 10725 2790");
    sequencer.iterate(25);
  ...
  @Test
  void explore() {
    final PlutoniumSequencer sequencer = new PlutoniumSequencer("0");
    sequencer.iterate(10);
    System.out.println("Part 2 = " + sequencer);
  }
